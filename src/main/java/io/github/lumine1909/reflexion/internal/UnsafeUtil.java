...
public class UnsafeUtil {
    ...
    private static final MethodHandle mh$objectFieldOffset;
    private static final MethodHandle mh$staticFieldBase;
    private static final MethodHandle mh$staticFieldOffset;
    ...
    static {
        try {
            ...
            mh$objectFieldOffset = IMPL_LOOKUP.findVirtual(class$InternalUnsafe, "objectFieldOffset", MethodType.methodType(long.class, Field.class));
            mh$staticFieldBase = IMPL_LOOKUP.findVirtual(class$InternalUnsafe, "staticFieldBase", MethodType.methodType(Object.class, Field.class));
            mh$staticFieldOffset = IMPL_LOOKUP.findVirtual(class$InternalUnsafe, "staticFieldOffset", MethodType.methodType(long.class, Field.class));
        } catch (Exception e) {
    ...
    public static void putValue(Field target, Object value) {
